...
public class TrieST<Value> {
   ...
   /**
     ...
     */
    public Iterable<String> key_match(String pattern) {
        Queue<String> results = new Queue<String>();
    ...
    public Iterable<String> matchingkeys(String pattern) {
        Queue<String> results = new Queue<String>();
        collect(root, new StringBuilder(), pattern, results);
        return results;
    }
    
    	  public  int count(String string, String substr) {
    ...
    public static void main(String[] args) throws FileNotFoundException {        
        ...
        String txt =  new Scanner(new File("C:\\\\Study_Mac\\\\Advanced_Computing\\\\Assignment4\\\\Text Processing\\\\Text Processing\\\\textprocessing\\\\Protein.txt")).useDelimiter("\\A").next();
     ...
     TST<Queue<Integer>> stt = new TST<Queue<Integer>>();
       // StdOut.println("key_match(\"protein\"):");
        ...
        for(String s:tst.matchingkeys("protein")) {
            if(!   stt.contains(s))
                  stt.put( s,   new  Queue<Integer>());
            else
          stt.get(s).enqueue(tst.get("planarity"));                          
         System.out.println("Occurence at "+tst.get("planarity"));
        }  
     System.out.println("No of occurrence:"+tst.count(txt, "planarity"));
    }
}
